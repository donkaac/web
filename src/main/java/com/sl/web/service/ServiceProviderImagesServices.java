...
public class ServiceProviderImagesServices {
    ...
    public Response getById(@PathParam("id") Integer id) {
        ServiceProviderImages serviceProviderImages = controller.getById(ServiceProviderImages.class, id);
        return Response.status(200).entity(serviceProviderImages).build();
    }
